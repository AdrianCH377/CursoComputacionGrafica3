...
//	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion basica- Santiago Cruz-318103273", nullptr, nullptr);
//
//	if (nullptr == window)
//	{
...
int main()
{
	...
	// Create a GLFWwindow object that we can use for GLFW's functions
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion basica , Santiago Adrian Cruz Hernandez -318103273", nullptr, nullptr);
